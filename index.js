...
Don't stop at feeling better. Start living better.
        ...
        ctx.reply('Error: File unavailable. Contact @Mohamedlebah').catch(() => {});
    }
});
...
bot.action('buy_premium', (ctx) => {
    ...
    ctx.reply(paymentMsg, { parse_mode: 'Markdown' }).catch(() => {});
});
